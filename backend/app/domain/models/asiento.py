...
from sqlalchemy import String, DateTime, ForeignKey, Text, Numeric, Date, Boolean, Integer
...
class Asiento(Base):
    ...
    # Nuevos campos: integracion con Document Engine
...
class AsientoLinea(Base):
    ...
    debe_local: Mapped[Decimal] = mapped_column(Numeric(14, 2), default=0)
    haber_local: Mapped[Decimal] = mapped_column(Numeric(14, 2), default=0)
    debe_dolar: Mapped[Decimal] = mapped_column(Numeric(14, 2), default=0)
    haber_dolar: Mapped[Decimal] = mapped_column(Numeric(14, 2), default=0)
