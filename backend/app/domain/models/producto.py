...
class Producto(Base):
    ...
    cuenta_compra_id: Mapped[uuid.UUID | None] = mapped_column(Uuid(), ForeignKey("cuenta_contable.id"))
    cuenta_venta_id: Mapped[uuid.UUID | None] = mapped_column(Uuid(), ForeignKey("cuenta_contable.id"))
    cuenta_inventario_id: Mapped[uuid.UUID | None] = mapped_column(Uuid(), ForeignKey("cuenta_contable.id"))
