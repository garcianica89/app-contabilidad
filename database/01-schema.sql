...
CREATE TYPE tipo_asiento AS ENUM (
    'APERTURA', 'CIERRE', 'COMPRA', 'VENTA', 'CAJA', 'BANCO', 'DIARIO'
);

CREATE TYPE tipo_documento AS ENUM (
    'FACTURA', 'NC', 'ND', 'ORDEN_COMPRA', 'RECIBO', 'CHEQUE', 'TRANSFERENCIA', 'DEPOSITO'
);

CREATE TYPE tipo_kardex AS ENUM (
...
CREATE TYPE estado_documento AS ENUM (
    'EMITIDA', 'COBRADA', 'PAGADA', 'ANULADA', 'PENDIENTE'
);
...
CREATE TABLE factura_venta (
    ...
    tipo tipo_venta NOT NULL DEFAULT 'CONTADO',
    ...
    estado estado_documento NOT NULL DEFAULT 'EMITIDA',
    created_at TIMESTAMP NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMP,
...
CREATE TABLE cuenta_banco (
    ...
    tipo tipo_cuenta_banco NOT NULL DEFAULT 'CORRIENTE',
    moneda_id UUID NOT NULL REFERENCES moneda(id),
    saldo DECIMAL(14,2) NOT NULL DEFAULT 0,
    activa BOOLEAN NOT NULL DEFAULT TRUE,
    created_at TIMESTAMP NOT NULL DEFAULT NOW(),
